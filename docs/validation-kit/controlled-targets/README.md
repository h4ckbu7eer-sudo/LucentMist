...
The report generator uses the published `0.9.8` image and writes `docs/validation-report.html`. A completed report is review material, not evidence that user interviews or report reviews occurred.
